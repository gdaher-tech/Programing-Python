...
class Doador(Pessoa):
    ...
    banco_doador = {}  # Banco de doadores
    ...
    def cadastrar(self):
        ...
        validar_cpf(self._Pessoa__cpf)  # Acessando atributo privado
        validar_profissao(self._Pessoa__profissao)
        validar_cidadeResidencia(self._Pessoa__cidade_residencia)
        validar_estadoResidencia(self._Pessoa__estado_residencia)
        ...
        if self._Pessoa__cpf in Doador.banco_doador:
            raise ValueError("CPF já cadastrado como doador.")

        Doador.banco_doador[self._Pessoa__cpf] = self
    ...
    def excluir(self):
        ...
        """
        if self._Pessoa__cpf in Doador.banco_doador:
            del Doador.banco_doador[self._Pessoa__cpf]
            print("Doador excluído com sucesso.")
        else:
            print("Doador não encontrado no banco.")

    @property
    def cpf(self):
        """
        Getter para acessar o CPF do doador de forma segura.
        """
